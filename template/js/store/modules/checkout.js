import {
  ...
  const actions = {
    ...
    sendCheckout ({ getters }, payload) {
      ...
      if (checkoutBody.transaction && checkoutBody.transaction.discount && checkoutBody.transaction.discount.value && checkoutBody.transaction.discount.value < 0) {
        delete checkoutBody.transaction.discount
      }
